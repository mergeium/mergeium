...
"%JAVA%" %KC_OPTS% -cp "%DIRNAME%\client\keycloak-admin-cli-26.5.5.jar" --add-opens=java.base/java.security=ALL-UNNAMED -Dkc.lib.dir="%DIRNAME%\client\lib" org.keycloak.client.registration.cli.KcRegMain %*
